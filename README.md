...
8. Set `pom.xml` as Maven by right-clicking on the `pom.xml` file and selecting "Add as Maven Project." You may need to reload the Maven project.
9. Once the API key and the Maven Project are set up, you can run the Main program.
