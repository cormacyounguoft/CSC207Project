...
public class RateView extends JPanel implements PropertyChangeListener {
    ...
    private static final int INPUT_FIELD_WIDTH = 150;
    ...
    private JPanel createTopPanel() {
        ...
        configureLabel(usernameLabel, topPanel);
        configureLabel(movieLabel, topPanel);
    ...
    private void handleRateAction() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    this, "The rating must be an integer between 0 and 5.");
        }
