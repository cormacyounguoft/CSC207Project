...
public class WatchlistRemoveInteractor implements WatchlistRemoveInputBoundary {
    ...
    public WatchlistRemoveInteractor(WatchlistRemoveOutputBoundary presenter, WatchlistRemoveDataAccessInterface dataAccessInterface){
    ...
    public void execute(WatchlistRemoveInputData inputData) {
        ...
        final WatchlistRemoveOutputData outputData = new WatchlistRemoveOutputData(false, inputData.getUsername());
